...
function Recipes({categories, meals}){
    return(
        <View className="mx-4 space-y-3">
            <Text style={{fontSize: hp(3)}} className="font-semibold text-neutral-600">Recetas</Text>
            <View>
                {
...
//componente para listar recetas, con  animaciones, la imagen y un titulo, todo de manera responsiva
